...
static NSString *currentChatBuddyJid = nil;

@interface IMChat ()<UITableViewDelegate, UITableViewDataSource,
 IMChatSendBarDelegate>
...
- (instancetype)initWithBuddyJID:(NSString *)buddyJID buddyName:(NSString *)buddyName
{
    ...
    if (self) {
        ...
        [IMChat setCurrentBuddyJid:buddyJID];
        
        self.title = buddyName ?: buddyJID;
...
//    XMPPMessageArchiving_Message_CoreDataObject *coreDataMessage = [self.viewModel objectAtIndexPath:indexPath];
    IMChatMessageBaseEntity *message = nil;
